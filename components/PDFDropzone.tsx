        ...
        <DndContext sensors={sensors}>
            <div className="w-full max-w-md mx-auto">
                <div
                    ...
                    onDrop={handleDrop}
                    className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${isDraggingOver ? "border-blue-500 bg-blue-50" : "border-gray-300"} ${!canUpload ? "cursor-not-allowed opacity-70" : ""}`}
                >
                    {isUploading ? (
                        ...
                        <ul className="mt-2 text-sm text-gray-600 space-y-1">
                            {uploadedFiles.map((fileName, i) => (
                                <li key={i} className="flex items-center">
                                    <CheckCircle className="h-5 w-5 mr-2 text-green-500 mr-2" />
                                    {fileName}
                                </li>
                            ))}
                        </ul>
