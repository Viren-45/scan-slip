...
function Receipt() {
    ...
    // Function to delete a receipt using server action
    ...
    // Conver the URL string Id to a Convex ID
    useEffect(() => {
      try {
                      ...
                      {isSummariesEnabled ? (
                        ...
                        <div className="mt-6 bg-gray-100 p-6 rounded-lg border border-gray-200 shadow-sm">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                              <h4 className="font-semibold text-gray500">
                                AI Summary
                              </h4>
                              <div className="ml-2 flex">
                    ...
                    <Table>
                      ...
                      <TableFooter>
                        <TableRow>
                          ...
                          <TableCell className="font-medium">{formatCurrency(receipt.items.reduce((sum, item) => sum + item.totalPrice, 0), receipt.currency)}</TableCell>
                        </TableRow>
                      </TableFooter>
                    </Table>
                  </div>
                  ...
                  <button
                    className={`px-4 py-2 rounded text-sm ${
                      isDeleting
                        ...
                        : "bg-red-50 border border-red-200 text-red-600 hover:bg-red-100 hover:cursor-pointer"
                    }`}
