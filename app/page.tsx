...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Scan, analyze and organize your receipts with AI-powered preceision. Save time and gain insights from your expenses
              </p>
            </div>
      ...
      {/* Pricing Section */}
      <section className="py-16 md:py-24bg-gray-50 dark:bg-gray-900">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-800 dark:bg-gray-950">
              ...
              <div className="mt-6">
                <Link href="/manage-plan">
                  <Button className="w-full cursor-pointer" variant="outline">Sign Up Free</Button>
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col p-6 bg-blue-50 border border-blue-200 rounded-lg relative dark:border-blue-900 dark:bg-blue-900/20">
              ...
              <div className="mt-6">
                <Link href="/manage-plan">
                  <Button className="w-full bg-blue-600 hover:bg-blue-700 cursor-pointer">Get Started</Button>
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-6 mx-auto py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4">
            <div className="flex items-center space-x-1">
              ...
              <span className="text-xl font-semibold">ScanSlip</span>
            </div>
            <div className="mt-4 md:mt-0">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Scanslip. The smarter way to track your money
              </p>
            </div>
          </div>
        </div>
